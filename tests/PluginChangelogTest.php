...
use Required\ComposerScripts\PluginChangelogPlugin;

class PluginChangelogPluginTest extends TestCase {
	/** @var BufferIO */
	private $io;
	...
	public function test_it_is_registered_and_activated() {
		$plugin = new PluginChangelogPlugin();
	...
	public function test_it_receives_event() {
		$this->addComposerPlugin( new PluginChangelogPlugin() );
